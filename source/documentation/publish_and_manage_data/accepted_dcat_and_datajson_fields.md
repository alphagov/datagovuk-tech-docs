...
When using or data.json, it’s common to use additional fields from other vocabularies. This guidance explains the fields that the data.gov.uk directory will accept.
