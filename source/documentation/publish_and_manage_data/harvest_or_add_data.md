...
* using software to harvest datasets
* adding datasets manually using a form
...
>You must harvest [Location/INSPIRE data](/appendices/inspire/#inspire).
...
* the [guidance on accepted CKAN fields](xxx)
...
If you don’t want to [automatically harvest datasets](xxx), you can add a dataset to data.gov.uk using an online form. You must submit one form per dataset.
...
Find the dataset you want to update.
Select **Manage**.
Select **Add data**.
Select **Add new resource** and add details of the dataset you want to upload.
Select **Publish**.
